export default function ExperienceItem({ item, onChange, dragHandlers, onDelete, showResponsibilities = false, isDragging = false }) {
	return (
		<div
			className={`experience-card ${isDragging ? 'dragging' : ''}`}
